...
public class ManageSetDOWaitDO {
    ...
    public static void main(String[] args) throws IOException {
        ...
        FileReader fr = new FileReader("/home/opt1musenpai/Darpan/Meenakshi mam summer project/task analyzer/Rapid-program-parser/src/InputRules/rule5.txt"); // path to source rapid file
        ...
        System.out.println("                             *****************                                       ");
        System.out.println("             Rule#5 : Checked SetDO - WaitDO task instruction !!");
        System.out.println("                             *****************                                       ");
